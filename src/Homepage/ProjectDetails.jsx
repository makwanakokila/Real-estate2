...
const ProjectDetails = () => {
  ...
  return (
    <div className="bg-white font-sans">
      ...
      <section className="bg-[#1C1C1C] text-white py-20">
        <div className="container mx-auto px-6 md:px-8 text-center">
          ...
          <div className="flex justify-center flex-wrap gap-4">
            ...
            <button
              onClick={() => navigate(`/explore/${project.id}`)} // Keep your original navigation logic
      ...
      <AnimatePresence>
        {showModal && <ContactFormModal propertyName={propertyForUI.name} onClose={() => setShowModal(false)} />}
      </AnimatePresence>
    </div>
  )
}
